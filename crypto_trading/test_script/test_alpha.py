...
使用方法：
    ...
    python -m crypto_trading.test_script.test_alpha
    
    # 方式2: 直接运行脚本
    cd /Users/user/Desktop/repo/crypto_trading
    python crypto_trading/test_script/test_alpha.py
"""
...
# test_alpha.py 位于: crypto_trading/crypto_trading/test_script/test_alpha.py
...
try:
    ...
    print("  python -m crypto_trading.test_script.test_alpha")
    print("\n或者直接运行脚本：")
    print("  cd /Users/user/Desktop/repo/crypto_trading")
    print("  python crypto_trading/test_script/test_alpha.py")
    sys.exit(1)
...
def main():
    ...
    print("  - 推荐使用模块方式运行: python -m crypto_trading.test_script.test_alpha")
