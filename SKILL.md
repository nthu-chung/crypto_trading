...
`自然語言 -> 正式策略規格 -> 下載 crypto_trading repo -> standard_bot 回測 / paper signal -> 查餘額 -> 使用者 CONFIRM -> 在指定時長內根據 paper signal 執行真實交易`

---

## 10. 監聽通知與 workspace session 規範
