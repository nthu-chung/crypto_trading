...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-json", default="docs/backtests/llm_strategy_evolution_2026-04-13.json")
    parser.add_argument("--output-md", default="docs/backtests/llm_strategy_evolution_2026-04-13.md")
    return parser


def seed_candidates() -> List[StrategyCandidate]:
    return [
...
def main() -> int:
    ...
    for round_index in range(1, args.rounds + 1):
        ...
        survivors = [result for result, _ in ranked_internal[: args.survivors]]
        rounds_payload.append(
            {
                "round": round_index,
                "population_size": len(population),
                "ranked": evaluated,
                "survivors": [item["candidate_id"] for item in evaluated[: args.survivors]],
            }
        )
