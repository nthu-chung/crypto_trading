            ...
            try:
                ...
                context = RunContext(
                    ...
                    signal_pipeline=build_strategy_pipeline(
                        ...
                        adx_threshold=float(payload.get("adx_threshold", 25.0)),
                        atr_ma_period=int(payload.get("atr_ma_period", 20)),
                        atr_period=int(payload.get("atr_period", 14)),
                        atr_multiplier=float(payload.get("atr_multiplier", 2.0)),
                        bollinger_period=int(payload.get("bollinger_period", 20)),
                        bollinger_stddev_multiplier=float(payload.get("bollinger_stddev_multiplier", 2.0)),
                        macd_fast_period=int(payload.get("macd_fast_period", 12)),
                        macd_slow_period=int(payload.get("macd_slow_period", 26)),
                        macd_signal_period=int(payload.get("macd_signal_period", 9)),
                        macd_histogram_threshold=float(payload.get("macd_histogram_threshold", 0.0)),
